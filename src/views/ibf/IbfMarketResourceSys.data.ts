...
export const formSchema: FormSchema[] = [
  {
    ...
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入市场ID缩写!' }];
    },
  },
  {
    label: '市场名称',
  ...
  },
  {
    ...
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入间数（商位）!' }];
    },
  },
  {
    label: '间数（配套）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入间数（配套）!' }];
    },
  },
  {
    label: '已出租间数（商位+配套）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入已出租间数（商位+配套）!' }];
    },
  },
  {
    label: '面积（商位）㎡',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入面积（商位）㎡!' }];
    },
  },
  {
    label: '面积（配套）㎡',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入面积（配套）㎡!' }];
    },
  },
  {
    label: '已出租面积（商位+配套）㎡',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入已出租面积（商位+配套）㎡!' }];
    },
  },
  {
  ...
  },
  {
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入人流（人次）!' }];
    },
  },
  {
    label: '车流（人次）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入车流（人次）!' }];
    },
  },
  {
    label: '外商（人次）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入外商（人次）!' }];
    },
  },
  {
    label: '开门率 %',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入开门率 %!' }];
    },
  },
  {
    label: '市场成交额（亿）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入市场成交额（亿）!' }];
    },
  },
  {
    label: '商位转让笔数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入商位转让笔数!' }];
    },
  },
  {
    label: '商位转让均价（元）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入商位转让均价（元）!' }];
    },
  },
  {
    label: '商位转租笔数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入商位转租笔数!' }];
    },
  },
  {
    label: '商位转租均价（元）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入商位转租均价（元）!' }];
    },
  },
  {
    label: '商位质押笔数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入商位质押笔数!' }];
    },
  },
  {
    label: '商位质押总金额（元）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入商位质押总金额（元）!' }];
    },
  },
  {
    label: '商位普通装修笔数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入商位普通装修笔数!' }];
    },
  },
  {
    label: '商位个性化装修笔数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入商位个性化装修笔数!' }];
    },
  },
  {
    label: '本年招商户数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入本年招商户数!' }];
    },
  },
  {
    label: '本年招商间数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入本年招商间数!' }];
    },
  },
  {
    label: '当前空置户数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入当前空置户数!' }];
    },
  },
  {
    label: '当前空置间数',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入当前空置间数!' }];
    },
  },
  {
    label: '本年入场资格费收入（万）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入本年入场资格费收入（万）!' }];
    },
  },
  {
  ...
  },
  {
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入本年续租户数（户）!' }];
    },
  },
  {
    label: '本年退租户数（户）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入本年退租户数（户）!' }];
    },
  },
  {
    label: '本年到期户数（户）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入本年到期户数（户）!' }];
    },
  },
  {
    label: '本年续租收入（万）',
    ...
    component: 'InputNumber',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入本年续租收入（万）!' }];
    },
  },
  {
