...
export const columns: BasicColumn[] = [
  ...
  },
  {
    ...
    helpMessage: '本年招商间数，记录本年招商间数，单位间',
    customRender: ({ text }) => (text ? `${text}间` : ''),
  },
  {
    title: '当前空置间数',
...
export const formSchema: FormSchema[] = [
  ...
  },
  {
    ...
    helpMessage: ['数据口径：本年招商间数', '单位：间，精确到1位小数', '统计时间：所属年月的月末'],
    dynamicRules: () => {
      return [
  ...
  },
  {
    ...
    helpMessage: ['数据口径：当前空置间数', '单位：间，精确到1位小数', '统计时间：所属年月的月末'],
    dynamicRules: () => {
      return [
  ...
  },
  {
    ...
    helpMessage: ['数据口径：', '当月的日均人次，市场摄像头监测', '单位：', '人次', '统计周期：', '所属年月自然月的起止日期'],
    dynamicRules: ({ model, schema }) => {
      return [
  ...
  },
  {
    ...
    helpMessage: ['数据口径：', '当月的日均，按车辆进入次数统计', '单位：', '车次', '统计周期：', '所属年月自然月的起止日期'],
    dynamicRules: ({ model, schema }) => {
      return [
  ...
  },
  {
    ...
    helpMessage: [
      ...
      '统计时间：',
      '所属年月的月末。',
      '其中1月为上月16日至1月31日；12月为截至本年12月16日之前；',
      '本年是指上一自然年12月16日-本自然年12月15日',
      '例：所属年月选了2024/12，则统计的范围为2023/12/16-2024/12/15',
      '例：所属年月选择了2024/01，则统计的范围为2023/12/16-2024/01/31',
    ],
