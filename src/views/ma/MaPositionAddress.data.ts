...
export const formSchema: FormSchema[] = [
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入点位位置类型!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入点位详细位置!'},
          ];
     },
  },
  {
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入点位位置状态!'},
          ];
     },
  },
	// TODO 主键隐藏字段，目前写死为ID
