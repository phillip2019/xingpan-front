<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <EtEventPropertyModal @register="registerModal" @success="handleSuccess"></EtEventPropertyModal>
  </div>
</template>

<script lang="ts" name="org.jeecg.et-etEventProperty" setup>
