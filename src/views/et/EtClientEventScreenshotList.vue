<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <EtClientEventScreenshotModal @register="registerModal" @success="handleSuccess"></EtClientEventScreenshotModal>
  </div>
</template>
...
<script lang="ts" name="et-etClientEventScreenshot" setup>
  ...
  import {columns, searchFormSchema} from './EtClientEventScreenshot.data';
