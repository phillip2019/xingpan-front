<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <TbRestMerchantRelationModal @register="registerModal" @success="handleSuccess"></TbRestMerchantRelationModal>
  </div>
</template>
...
<script lang="ts" name="tb-tbRestMerchantRelation" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './TbRestMerchantRelation.api';
